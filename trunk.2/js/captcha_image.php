...
imagecolorallocate ($captchaImage, 255, 255, 255); // Assign background color (white)
$text_color = imagecolorallocate ($captchaImage, 0, 0, 0);      // text color is given (black) 
imagestring($captchaImage,5,5,2,$_SESSION['captcha'],$text_color); // Random string  from session added 
