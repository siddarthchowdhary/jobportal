...
--
-- Host: localhost
-- Generation Time: Apr 05, 2013 at 08:37 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='employer profile details' AUTO_INCREMENT=10 ;
...
CREATE TABLE IF NOT EXISTS `jobs_applied` (
  ...
  KEY `job_id` (`job_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='details of job applied' AUTO_INCREMENT=172 ;
...
(10, 2, '2013-04-04 14:52:37', 144),
(7, 2, '2013-04-04 15:11:07', 151),
(8, 2, '2013-04-04 15:11:10', 152),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='login details of jobseeker and employer' AUTO_INCREMENT=35 ;
