...
--
-- Host: localhost
-- Generation Time: Mar 28, 2013 at 07:57 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='jobseeker educational details' AUTO_INCREMENT=3 ;
...
(2, 6, 'MBA', 'BCA', 'MCA', '', '', '2013-03-28 12:51:47');
...
CREATE TABLE IF NOT EXISTS `jobseeker_professional_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `personal_id` (`personal_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='jobseeker professional details' AUTO_INCREMENT=3 ;
...
(2, 6, 10, 'php,mysql', 'IT-Software Development', 'php', '2013-03-28 12:22:33');
...
CREATE TABLE IF NOT EXISTS `jobs_applied` (
  ...
  KEY `job_id` (`job_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='details of job applied' AUTO_INCREMENT=22 ;
