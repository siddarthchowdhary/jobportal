...
(2, 6, 'MCA', 'BCA', 'MCA', '', '', '2013-03-28 12:51:47'),
...
CREATE TABLE IF NOT EXISTS `jobseeker_personal_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='jobseeker personal details' AUTO_INCREMENT=8 ;
...
(6, 2, 'siddarth', '', 'chowdhary', '10', '1989-12-05', 'Malviya Nagar', 'Malviya Nagar', 'New Delhi', 'delhi', 'india', 110017, 110017, '2013-03-28 10:26:22'),
...
CREATE TABLE IF NOT EXISTS `jobs_applied` (
  ...
  KEY `job_id` (`job_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='details of job applied' AUTO_INCREMENT=12 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='login details of jobseeker and employer' AUTO_INCREMENT=11 ;
...
(7, 'mnbvcxz', 'chetan sharma', 'chetan@osscube.com', 3, '2013-03-20 18:34:45', '2013-03-20 13:04:45', '0'),
(10, 'abhishek', 'abhishek arora', 'abhishek.arora@osscube.com', 2, '0000-00-00 00:00:00', '2013-03-29 11:23:42', '1');
