...
--
-- Host: localhost
-- Generation Time: Apr 13, 2013 at 11:27 AM
...
(0, 'TipOfDay', '', 'Asdfghjkl;''\r\n', '', '0000-00-00'),
(1, 'AboutUs', '', 'this project is developed for our internship purpose at OSSCube.', '', '0000-00-00'),
(2, 'ContactUS', '', 'ASHWANI\r\n\r\nPRINCE\r\n\r\nSAURABH\r\n\r\nSIDDARTH', '', '0000-00-00');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='employer profile details' AUTO_INCREMENT=25 ;
...
CREATE TABLE IF NOT EXISTS `inactive_users` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='inactive_users' AUTO_INCREMENT=6 ;

--
-- Dumping data for table `inactive_users`
--

INSERT INTO `inactive_users` (`id`, `user_id`, `validation_string`) VALUES
(5, 80, 'esMn*quOT!wgEkh51VHmlvB0c');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='jobseeker educational details' AUTO_INCREMENT=14 ;
...
(2, 6, 'MBA', 'BCA', 'MCA', 'none', 'none', '2013-03-28 12:51:47'),
(3, 7, 'MCA', 'BCA', 'MCA', '', '', '2013-03-29 09:40:22'),
(13, 11, 'MCA', '', '', '', '', '2013-04-12 10:11:40');
...
CREATE TABLE IF NOT EXISTS `jobseeker_personal_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='jobseeker personal details' AUTO_INCREMENT=13 ;
...
(6, 2, 'siddarth', 'm', 'chowdhary', '10', '2012-12-13', 'Malviya Nagar', 'Malviya Nagar', 'delhi', 'delhi', 'India', 110017, '9873252330', '2013-03-28 10:26:22'),
(7, 1, 'saurabh', '', 'agarwal', '10', '1989-11-17', 'bulandsheher', 'laxmi nagar', 'new delhi', 'delhi', 'india', 110092, '110092', '2013-03-29 09:39:48'),
(11, 78, 'qwerty', '', '', '10', '2009-11-02', '', '', '', '', '', 0, '', '2013-04-12 10:11:26');
...
CREATE TABLE IF NOT EXISTS `jobseeker_professional_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `personal_id` (`personal_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='jobseeker professional details' AUTO_INCREMENT=13 ;
...
(2, 6, 12, 'php,mysql,ajax,jquery', 'IT-Software Development', 'mysql', '2013-03-28 12:22:33'),
(3, 7, 10, 'dba', 'IT-Software Development', 'php', '2013-03-29 09:43:13'),
(8, 11, 12, '', 'IT-Software Development', '', '2013-04-12 10:11:34');
...
CREATE TABLE IF NOT EXISTS `jobseeker_resume` (
  ...
  PRIMARY KEY (`id`),
  KEY `personal_id` (`personal_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='jobseeker resume' AUTO_INCREMENT=11 ;
...
(1, 6, '', NULL, 'gz', '2013-04-05 11:15:10'),
(9, 11, '', NULL, 'gz', '2013-04-12 10:12:20');
...
CREATE TABLE IF NOT EXISTS `jobs_applied` (
  ...
  KEY `job_id` (`job_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='details of job applied' AUTO_INCREMENT=179 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='details of job available' AUTO_INCREMENT=12 ;
...
(7, 'software developer', 1, 8, '2013-04-02 13:40:10', '2013-08-07 00:00:00', 150089, '0', '2013-04-02 08:10:10', 'developer', 'noida', 'developer', 'php,mysql,java'),
(10, 'applet developer', 1, 8, '2013-04-13 08:29:46', '2013-09-08 00:00:00', 1000000, '0', '2013-04-13 02:59:46', 'developer', 'delhi', 'networking', 'mysql,php'),
(11, 'software developer', 2, 8, '2013-04-13 10:51:12', '2013-03-02 00:00:00', 1200000, '0', '2013-04-13 05:21:12', 'applet programming', 'hyderabad', 'java', 'java,php,mysql');
...
(1, 'iphone', 'http://www.ebay.in/sch/Mobile-', 'ads'),
(10, 'iphone', 'http://www.ebay.in/sch/Mobile-', 'logo');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='login details of jobseeker and employer' AUTO_INCREMENT=81 ;
...
(7, '58a39bfab24f8c96bfdd68b0c296cf7e', 'chetan prakash sharma', 'chetan@osscube.com', 3, '2013-03-20 18:34:45', '2013-03-20 13:04:45', '0'),
...
(78, 'd8578edf8458ce06fbc5bb76a58c5ca4', 'qwerty qwerty', 'qwerty@qwerty.com', 2, '2013-04-12 15:34:40', '2013-04-12 10:04:40', '0'),
(80, 'a152e841783914146e4bcd4f39100686', 'asdfgh asdfgh', 'asdfgh@asdfgh.com', 2, '2013-04-12 15:51:29', '2013-04-12 10:21:29', '1');
