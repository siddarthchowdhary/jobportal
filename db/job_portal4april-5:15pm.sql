...
--
-- Host: localhost
-- Generation Time: Apr 04, 2013 at 05:12 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='employer profile details' AUTO_INCREMENT=14 ;
...
(6, 2, 'Siddarth', '', 'Chowdhary', '10', '1989-12-05', 'Malviya Nagar', 'Malviya Nagar', 'New Delhi', 'delhi', 'India', 110017, '9873252330', '2013-03-28 10:26:22'),
(7, 1, 'saurabh', '', 'agarwal', '10', '1989-11-17', 'bulandsheher', 'laxmi nagar', 'new delhi', 'delhi', 'india', 110092, '110092', '2013-03-29 09:39:48'),
(8, 2, 'Siddarth', '', 'Chowdhary', '10', '1989-12-05', 'Malviya Nagar', 'Malviya Nagar', 'New Delhi', 'delhi', 'India', 110017, '9873252330', '2013-03-31 13:46:48');
...
CREATE TABLE IF NOT EXISTS `jobseeker_resume` (
  ...
  PRIMARY KEY (`id`),
  KEY `personal_id` (`personal_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='jobseeker resume' AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `jobs_applied` (
  ...
  KEY `job_id` (`job_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='details of job applied' AUTO_INCREMENT=110 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='details of job available' AUTO_INCREMENT=11 ;
...
(8, '', 0, 8, '2013-04-02 16:37:08', '0000-00-00 00:00:00', 0, '0', '2013-04-02 11:07:08', '', '', '', ''),
(9, 'software engineer', 5, 8, '2013-04-04 08:59:06', '2013-12-12 00:00:00', 300000, '0', '2013-04-04 03:29:06', 'lorem ipsim', 'noida', 'it_consultant', 'php,java,mysql'),
(10, 'http://localhost/jobportal/trunk/indexMa', 0, 8, '2013-04-04 10:38:53', '0000-00-00 00:00:00', 0, '0', '2013-04-04 05:08:53', 'http://localhost/jobportal/trunk/indexMain.php?controller=pages&function=updateProfessional', 'http://localhost/job', 'http://localhost/job', 'http://localhost/jobportal/trunk/indexMain.php?controller=pages&function=updateProfessional');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='login details of jobseeker and employer' AUTO_INCREMENT=21 ;
...
(15, 'fbb1b3d8ca94bac2fb046742c957b61c', '~!@#$%^&*() ~!@#$%^&*()', 'siddarth@osscube.com', 2, '2013-04-04 10:27:59', '2013-04-04 04:57:59', '1'),
(16, 'e11170b8cbd2d74102651cb967fa28e5', '<script>window.location.href="http://www.osscube.i', 'ddd@gmai.com', 3, '2013-04-04 10:30:14', '2013-04-04 05:00:14', '0'),
(17, 'd41d8cd98f00b204e9800998ecf8427e', '<script>window.location.href = "http://www.osscube', '', 3, '2013-04-04 11:39:04', '2013-04-04 06:09:04', '0'),
(20, '6eea9b7ef19179a06954edd0f6c05ceb', '~!@#$%^&*() <script>window.location.href="http://w', 'abc@abc.com', 2, '2013-04-04 11:46:05', '2013-04-04 06:16:05', '1');
