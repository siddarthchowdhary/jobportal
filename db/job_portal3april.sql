...
--
-- Host: localhost
-- Generation Time: Apr 03, 2013 at 09:36 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='employer profile details' AUTO_INCREMENT=9 ;
...
(2, 6, 'MCA', 'BCA', 'MCA', 'none', '', '2013-03-28 12:51:47'),
...
CREATE TABLE IF NOT EXISTS `jobseeker_resume` (
  ...
  PRIMARY KEY (`id`),
  KEY `personal_id` (`personal_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='jobseeker resume' AUTO_INCREMENT=5 ;

--
-- Dumping data for table `jobseeker_resume`
--

INSERT INTO `jobseeker_resume` (`id`, `personal_id`, `resume`, `resume_header`, `extension`) VALUES
(4, 6, '', NULL, 'pdf');
...
CREATE TABLE IF NOT EXISTS `jobs_applied` (
  ...
  KEY `job_id` (`job_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='details of job applied' AUTO_INCREMENT=31 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='details of job available' AUTO_INCREMENT=9 ;
...
(4, 'software developer', 1, 8, '2013-04-02 13:27:27', '2013-11-13 00:00:00', 10000, '0', '2013-04-02 07:57:27', 'applet developer', 'delhi', 'java developer', 'java,php'),
(5, 'software developer', 1, 8, '2013-04-02 13:28:21', '2013-11-13 00:00:00', 10000, '0', '2013-04-02 07:58:21', 'applet developer', 'delhi', 'java developer', 'java,php'),
(6, 'software developer', 1, 8, '2013-04-02 13:29:45', '2013-11-13 00:00:00', 10000, '0', '2013-04-02 07:59:45', 'applet developer', 'delhi', 'java developer', 'java,php'),
